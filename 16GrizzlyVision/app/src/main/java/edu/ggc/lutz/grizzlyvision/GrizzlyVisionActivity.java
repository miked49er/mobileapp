...
public class GrizzlyVisionActivity extends AppCompatActivity {
    ...
    private static final String CLOUD_VISION_API_KEY = "<<YOUR API KEY HERE>>";
    private static final String ANDROID_CERT_HEADER = "X-Android-Cert";
    private static final String ANDROID_PACKAGE_HEADER = "X-Android-Package";

    private static final String TAG = GrizzlyVisionActivity.class.getSimpleName();
    ...
    private void callCloudVision(final String loc) throws IOException {
        ...
        new AsyncTask<Object, Bitmap, String>() {
            ...
            protected void onProgressUpdate(Bitmap... bitmaps) {
                ...
                mMainImage.setImageBitmap(bitmaps[0]);
            }
